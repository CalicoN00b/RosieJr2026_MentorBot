...
public class Intake extends SubsystemBase {
  ...
  private final Alert slapdownDisconnectedAlert =
      new Alert("Intake slapdown motor disconnected!", AlertType.kError);
  private final Alert wheelsDisconnected =
      new Alert("Intake wheels motor disconnected", AlertType.kError);
